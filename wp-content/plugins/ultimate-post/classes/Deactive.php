		...
		if (!isset($_GET['postx_tracking'])) {
			echo '<div class="notice notice-success">';
				echo '<div class="wpxpo-btn-tracking-notice">';
					...
					echo '<a href="'.esc_url( add_query_arg( 'postx_tracking', 'yes' ) ).'" class="button button-primary wpxpo-btn-tracking">' . __( "Allow", "ultimate-post" ) . '</a> ';
					echo '<a href="'.esc_url( add_query_arg( 'postx_tracking', 'no' ) ).'" class="button-secondary button-large wpxpo-btn-tracking">' . __( "No Thanks", "ultimate-post" ) . '</a>';
				echo '</div>';
			echo '</div>';
		}
