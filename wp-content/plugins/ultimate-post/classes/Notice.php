...
class Notice {
	...
	public function set_dismiss_notice_callback() {
        ...
        if ($_GET['disable_postx_notice_v1'] == 'yes') {
                ...
                if (!isset($_GET['disable_postx_notice_v1'])) {
                    ...
                    <div class="wc-install ultp-pro-notice">
                        ...
                        <!-- <div class="wc-install-body">
                            <div><?php //_e('<strong>PostX - ⚡Flash Sale⚡</strong> is LIVE! Spend <strong style="color:#1cb53e;">25% LESS</strong> on Premium Features for a <strong>⏳LIMITED Time!</strong>', 'ultimate-post'); ?></div>
                        ...
                        <div class="wc-install-body">
                            <div><?php _e("Be a part of <strong>PostX's</strong> 🍉 <strong style='color:#1cb53e;'>Summer Sale</strong> Celebration by Getting Up to 🔥 <strong>30% DISCOUNT</strong> on PostX! ", 'ultimate-post'); ?></div>
                           <!--  <div><?php //_e('Thanks for using the free version of <strong>PostX Gutenberg Blocks</strong>. We have a special <strong>20% discount</strong> for a limited time. Use this coupon:', 'ultimate-post'); ?><strong><code>POSTXAD20</code></strong></div> -->
                            <a class="button button-primary button-hero ultp-btn-notice-pro" target="_blank" href="<?php echo ultimate_post()->get_premium_link(); ?>"><span class="dashicons dashicons-image-rotate"></span><?php _e('Upgrading to Pro', 'ultimate-post'); ?></a>
                            <a class="button-secondary button-large" href="<?php echo esc_url( add_query_arg( 'disable_postx_notice_v1', 'yes' ) )?>"><?php _e('No Thanks / Close.', 'ultimate-post'); ?></a>
                        </div>
                    </div>
                    <?php
                }
